...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Simple adapter that uses the RssItem toString method to display titles
//        adapter = new ArrayAdapter<RssItem>(this,android.R.layout.simple_list_item_1,rssItemList);

        // Custom ArrayAdapter to display RssItem title and description
